var income, incomeChanges, expenses, expenseReduction, assets, assetValues, debts, 
      debtDetails, shortTermGoals, longTermGoals, riskTolerance, investmentFluctuations, 
      emergencyFund, insuranceTypes, insuranceGaps, financialConfidence, financeAreas, financialResponses;
      function submitFinancialForm() {
        ...
        expenseReduction =
          document.getElementById("expenseReduction").value;
        ...
        financialConfidence = document.getElementById(
          "financialConfidence"
        ).value;
      ...
      function callChatbotAPI() {
        ...
        chatbotOutputDiv.innerHTML =
              "<strong>Interpreting the answer</strong><br>"
        var data = {
          contents: [
            {
              parts: [
                {
                  text: "Interpret the financial data I wrote below and provide some observations and ways to improve if possible as a financial advisor."+
